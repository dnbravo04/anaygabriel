    ...
    <div className="text-oldrose">
      <div>
        ...
        <button className="flex w-3/4 items-center justify-center mx-auto border font-semibold border-auburn bg-oldrose bg-opacity-50 hover:bg-opacity-70 text-whitesmoke py-2 px-8">
          <a target="_blank" href="https://calendar.google.com/calendar/event?action=TEMPLATE&amp;tmeid=NHAwdjE2cGdxanZmY21kbWUxMmx0YjJnNXEgbWF0cmltb25pb2FuYXlnYWJyaWVsQG0&amp;tmsrc=matrimonioanaygabriel%40gmail.com">Agregar al Calendario</a>
        </button>
      </div>
